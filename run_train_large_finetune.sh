...
--nproc_per_node=8 --master_port $PORT train_weather_continue.py \
--model mae_vit_large_patch16_dec512d8b_input256  \
--input_size 256 --batch_size 10 --mask_ratio 0.75 \
...
--save_ckpt_freq 3 \
--output_dir experiments/large_finetune/era5z500 \
--data_path /mnt/petrelfs/zhaoxiangyu1/data/Test100_256 \
--data_path_val /mnt/petrelfs/zhaoxiangyu1/data/Test100_256 | tee -a experiments/era5_z500_log.txt \
# > logs/ft_large_8gpus_new.log 2>&1 &
