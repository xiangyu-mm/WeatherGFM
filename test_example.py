...
def main(args):
    ...
    for target_id in target_ids:
        batch, data_type = get_batch_by_id(data_loader_val6, target_id)

        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val12, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='dblur', val_mode=True)
        # val_model_CNN_Head(model_without_ddp.cuda(), batch, 10, args.output_dir, mode='val_test',
        #                         patch_size=16, data_type='sevir', val_mode=True, idx=target_id+1)
        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val10, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='ir_predict', val_mode=True)
        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val2, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='trans', val_mode=True)
        val_model_CNN_Head(model_without_ddp.cuda(), batch, 10, args.output_dir, mode='val_test', 
                                patch_size=16, data_type='down_scaling_ir', val_mode=True,idx=target_id+1)
        # val_model_CNN_Head(model_without_ddp.cuda(), batch, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='down_scaling_vil', val_mode=True, idx=target_id+1)
        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val6, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='down_scaling_ir', val_mode=True)
        # val_model_CNN_Head(model_without_ddp.cuda(), batch, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='vis_recon', val_mode=True, idx=target_id+1)
        
        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val12, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='dblur', val_mode=True)
        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val7, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='rain_down_scaling', val_mode=True)
        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val8, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='sat_trans', val_mode=True)
        # val_model_CNN_Head(model_without_ddp.cuda(), data_loader_val11, 10, args.output_dir, mode='val_test', 
        #                         patch_size=16, data_type='NO2', val_mode=True)
...
# Finish
        # val_model_CNN_Head(model_without_ddp.cuda(), batch, 10, args.output_dir, mode='val_test',
        #                         patch_size=16, data_type='predict', val_mode=True, idx=target_id+1)
